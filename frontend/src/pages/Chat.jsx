...
What would you like to work on next?`,
  ...
  const autoUpdateEvent = async () => {
    if (!eventContext || messages.length < 2) {
      console.log('🚫 Auto-update skipped:', { hasEventContext: !!eventContext, messageCount: messages.length });
      return;
    }

    try {
      console.log('🔄 Starting auto-update for event:', eventContext.eventId);
      ...
      console.log('📋 Conversation to analyze:', conversationContent.substring(0, 300) + '...');
      ...
      if (!eventUpdateData || Object.keys(eventUpdateData).length === 0) {
        console.log('⚠️ No updates generated by AI, skipping save');
        return;
      }
      ...
      console.log('✅ Event auto-updated successfully:', response.data);
  ...
  const generateEventUpdateWithAI = async (conversationContent, eventCtx) => {
    try {
      console.log('🤖 Generating event update with AI...');
      console.log('📝 Conversation content:', conversationContent.substring(0, 200) + '...');
      ...
      console.log('✅ AI generated update:', response.data.eventData);
